...
namespace AutoPartsStore.DAL.Migrations
{
    public partial class test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PriceLists_Details_DetailId",
                        column: x => x.DetailId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetailFeature_Features_FeaturesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerModification_Modifications_ModificationsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetailModification_Modifications_ModificationsId",
                        column: x => x.ModificationsId,
                        principalTable: "Modifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerModification_ModificationsId",
                table: "CustomerModification",
                column: "ModificationsId");

            migrationBuilder.CreateIndex(
                name: "IX_DetailFeature_FeaturesId",
                table: "DetailFeature",
                column: "FeaturesId");

            migrationBuilder.CreateIndex(
                name: "IX_DetailModification_ModificationsId",
                table: "DetailModification",
                column: "ModificationsId");
